...
if (newsCount === 0) {
  ...
  const seed = [
    ...
    {
      title: '[EXEMPLO] Principais destaques do noticiário internacional',
      summary: 'Espaço reservado para notícias internacionais — atualize com as manchetes do dia.',
      content: 'Este espaço foi reservado para notícias internacionais (Mundo). Assim que houver interesse em manchetes específicas, é só pedir para atualizar esta seção com o conteúdo real.',
      image: img('mundo.jpg'),
      category: 'mundo',
      featured: 0
    }
  ...
  seed.forEach((n, i) => {
    insert.run(n.title, n.summary, n.content, n.image, n.category, n.featured, seedDates[i] || new Date().toISOString());
  });
}
